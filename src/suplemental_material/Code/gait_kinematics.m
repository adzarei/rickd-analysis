...
%   as well. Intermediate steps that create the transformation
%   matricies and joint centre locations are also outputted. The
%   last input is merely an indication if the user desires for
%   the outputs to be visualized in PLOTS.
%
%
%  INPUTS
%  --------
...
% the use of atan2 increases the stability by avoiding gimbal lock in
% the physiologically possible range of joint angles.
